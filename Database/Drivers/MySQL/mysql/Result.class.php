  ...
  public function fetch($how = \Snabb\Database\Connection::FETCH_ASSOC, $parameter = null)
  {
    ...
    switch($how) {
      case \Snabb\Database\Connection::FETCH_ASSOC:
        return mysql_fetch_array($this->result_stack[$this->stack_position],MYSQL_ASSOC);
      case \Snabb\Database\Connection::FETCH_NUM:
        return mysql_fetch_array($this->result_stack[$this->stack_position],MYSQL_NUM);
      case \Snabb\Database\Connection::FETCH_COLUMN:
         $data = mysql_fetch_array($this->result_stack[$this->stack_position],MYSQL_NUM);
